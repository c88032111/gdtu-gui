...
export default {
  ...
  methods: {
    ...
    createAccount:function(){
      ...
      let account = this.$web3.gdtu.accounts.create()
      this.createInfo.address = account.address;
      this.createInfo.privateKey = account.privateKey
      this.createInfo.keystore = this.$web3.gdtu.accounts.encrypt(account.privateKey, this.createInfo.pwd)
    ...
    importAccount () {
      ...
      if (this.importInfo.type === '0') {
        ...
        try {
          ...
          this.importInfo.keystore = this.$web3.gdtu.accounts.encrypt(this.importInfo.privateKey, this.importInfo.pwd)
        } catch (e) {
        ...
        try {
          account = this.$web3.gdtu.accounts.decrypt(this.importInfo.keystore, this.importInfo.pwd)
        } catch (e) {
      ...
      this.$web3.gdtu.getBalance(params.address)
          .then(data => {
              params.balance = data
              this.initAccount(params)
